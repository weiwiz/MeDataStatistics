...
var REPORT_DATA_TYPE = ["dailyReport", "monthlyReport", "yearlyReport", "allReport"];//["dailyReport", "monthlyReport", "yearlyReport", "allReport"];
...
var dataReduce = function (key, values) {
    ...
    if ("050608070001" === record.type) {
        ...
        record.data.power = sumCurPower / len;
